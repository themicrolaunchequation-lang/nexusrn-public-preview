(function(){
  ...
  window.NEXUS_MANIFEST = window.NEXUS_MANIFEST || {version:'v109-clinicalqa-wave4-structural-medsafety', canonicalDb: CANONICAL_DB};
  window.NEXUS_CURRENT_CANONICAL_DB = CANONICAL_DB;
  window.NEXUS_V109_CANONICAL_DB = CANONICAL_DB;
  ...
  if (typeof window.fetch === 'function') {
    ...
    function responseFromText(text){
      return new Response(text, { status: 200, headers: { 'Content-Type': 'application/json', 'X-NexusRN-DB': 'v109-clinicalqa-wave4-structural-medsafety' } });
    }
  ...
  function runtimeAudit(){
    ...
    return {
      version: 'v109-clinicalqa-wave4-structural-medsafety',
