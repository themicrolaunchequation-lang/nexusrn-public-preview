(function(){
  ...
  window.NEXUS_MANIFEST = window.NEXUS_MANIFEST || {version:'v111-wave6-authenticity-rewrite', canonicalDb: CANONICAL_DB};
  ...
  if (typeof window.fetch === 'function') {
    ...
    function responseFromText(text){
      return new Response(text, { status: 200, headers: { 'Content-Type': 'application/json', 'X-NexusRN-DB': 'v111-wave6-authenticity-rewrite' } });
    }
  ...
  function runtimeAudit(){
    ...
    return {
      version: 'v111-wave6-authenticity-rewrite',
