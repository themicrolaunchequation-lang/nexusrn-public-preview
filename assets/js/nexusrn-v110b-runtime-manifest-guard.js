(function(){
  ...
  window.NEXUS_MANIFEST = window.NEXUS_MANIFEST || {version:'v110b-wave5a-authenticityscan', canonicalDb: CANONICAL_DB};
  window.NEXUS_CURRENT_CANONICAL_DB = CANONICAL_DB;
  window.NEXUS_V110B_CANONICAL_DB = CANONICAL_DB;
  ...
  if (typeof window.fetch === 'function') {
    ...
    function responseFromText(text){
      return new Response(text, { status: 200, headers: { 'Content-Type': 'application/json', 'X-NexusRN-DB': 'v110b-wave5a-authenticityscan' } });
    }
  ...
  function runtimeAudit(){
    ...
    return {
      version: 'v110b-wave5a-authenticityscan',
...
try { window.NEXUS_V110B_RUNTIME_AUDIT = window.NEXUS_V101_RUNTIME_AUDIT; window.NEXUS_V110_RUNTIME_AUDIT = window.NEXUS_V101_RUNTIME_AUDIT; } catch(e) {}
