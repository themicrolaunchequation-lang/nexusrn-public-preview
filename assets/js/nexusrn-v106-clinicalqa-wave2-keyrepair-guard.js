(function(){
  'use strict';
  var CANONICAL_DB = 'data/questions-v106-clinicalqa-wave2-keyrepair.json';
  ...
  if (typeof window.fetch === 'function') {
    ...
    function responseFromText(text){
      return new Response(text, { status: 200, headers: { 'Content-Type': 'application/json', 'X-NexusRN-DB': 'v106-clinicalqa-wave2-keyrepair' } });
    }
  ...
  function runtimeAudit(){
    ...
    return {
      version: 'v106-clinicalqa-wave2-keyrepair',
...
try { window.NEXUS_V106_RUNTIME_AUDIT = window.NEXUS_V101_RUNTIME_AUDIT; } catch(e) {}
