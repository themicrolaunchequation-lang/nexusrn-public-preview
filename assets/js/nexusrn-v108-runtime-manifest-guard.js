(function(){
  ...
  window.NEXUS_MANIFEST = window.NEXUS_MANIFEST || {version:'v108-clinicalqa-wave3-demographics', canonicalDb: CANONICAL_DB};
  window.NEXUS_CURRENT_CANONICAL_DB = CANONICAL_DB;
  window.NEXUS_V108_CANONICAL_DB = CANONICAL_DB;
  ...
  if (typeof window.fetch === 'function') {
    ...
    function responseFromText(text){
      return new Response(text, { status: 200, headers: { 'Content-Type': 'application/json', 'X-NexusRN-DB': 'v108-clinicalqa-wave3-demographics' } });
    }
  ...
  function runtimeAudit(){
    ...
    return {
      version: 'v108-clinicalqa-wave3-demographics',
      ...
      note: 'v108 permanently quarantines unsafe OB/reproductive demographic contradictions and preserves v106 key repairs.'
    };
  }
